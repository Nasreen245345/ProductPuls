...
/**
 * @param {string} summary - AI-generated narrative summary
 * @param {{ label: string, product_name?: string }[]} painPoints
 * @param {{ label: string, mentions: number }[]} featureRequests
 */
  ...
  return (
    <Card className="border-ai-100 bg-gradient-to-br from-ai-50 to-surface-card p-5 dark:border-ai-500/20 dark:from-ai-500/10 dark:to-surface-card">
      <div className="flex items-center gap-2">
        ...
        <h3 className="text-card-heading text-primary">AI Insights</h3>
      </div>
